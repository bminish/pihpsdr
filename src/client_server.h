...
//
// The same number as feature/diversity-binaural, deliberately: the wire
// structs on the two branches are identical, so a client built from
// either one can talk to a server built from the other.
//
